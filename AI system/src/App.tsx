      ...
      <div className="w-72 bg-slate-950 border-r border-slate-700 flex flex-col">
        ...
        <div className="p-4 border-t border-slate-700">
          <div className="flex items-center gap-3 px-2">
            ...
            <div>
              <p className="text-white font-medium text-sm">AI Coder v2</p>
              <p className="text-slate-500 text-xs">Trợ lý lập trình AI</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <header className="border-b border-slate-700 bg-slate-900/50 backdrop-blur-sm">
          <div className="px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-white">AI Coder v2</h1>
          ...
          <div className="max-w-4xl mx-auto px-6 py-6 space-y-6">
            {!currentSession || currentSession.messages.length === 0 ? (
              <div className="text-center py-20">
                ...
                <h2 className="text-3xl font-bold text-white mb-3">Xin chào! Tôi là AI Coder v2</h2>
          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-6 py-4">
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium rounded-xl hover:from-emerald-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
              >
