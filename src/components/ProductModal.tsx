        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 px-5 py-3 text-white font-medium shadow-lg shadow-violet-500/20 hover:from-violet-600 hover:to-purple-700 transition-all active:scale-[0.98]"
            >
